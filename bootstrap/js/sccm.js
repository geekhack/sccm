...
function calculateMetric()
{
  ...
  var pubh=fctns.match(/(public)\s+(\w+)\s+(\w+)\s+(\w+)(\()((\w+)(\s+)(\w+)((\,)?)*)(\))+/g);
   ...
   alertValue="**WELCOME TO SCCM SOFTWARE-JAVA SCANNER**\n";
   alertValue+="**Developer: Rafael Wanjiku--@geekhack(Github Account)**\n";
   ...
   var pttlarray=[]; //public method occurrences
     ...
     else if(PRM!=null)
     {
       ...
       console.log("*****************************************");        
        ...
        //console.log("Private method calls="+prttlarray.length);
